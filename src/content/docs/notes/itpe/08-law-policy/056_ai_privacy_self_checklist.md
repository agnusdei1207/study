...
| 프라이버시 중심 설계(PbD, Privacy by Design) | 기획·설계 단계부터 개인정보 보호를 시스템과 업무에 반영하는 접근 |
| 개인정보 영향평가(PIA, Privacy Impact Assessment) | 법정 대상 개인정보파일에 대해 개인정보 침해 위험을 평가하는 제도 |
...
| 구분 | 핵심 |
|---|---|
| 정의 | **AI 개인정보보호 자율점검표**는 AI 개인정보 처리의 위험과 준수사항을 단계별로 확인하는 안내서 |
| 목적 | 개발·운영 과정에서 개인정보 침해 위험을 식별하고 보호조치를 점검하는 것 |

2021년 공개본은 자율점검 수단이며, 법령을 대신하거나 그 자체로 모든 서비스의 준수를 보장하지 않는다.
...
개인정보보호위원회가 2021년 공개한 개발자·운영자용 자료는 6개 원칙, 16개 점검항목, 54개 확인사항으로 구성되며, 자율점검은 법적 의무를 대신하지 않는다.
...
| 한계 | 해결 방안 |
|---|---|
| 2021년 점검표만 적용하면 후속 법령·생성형 AI 처리 지침을 놓칠 수 있음 | 현행 법령과 최신 AI 안내서를 연결해 항목을 갱신하고, 고위험 처리의 검토·근거를 기록 |

## 출제 이력과 검증 출처

- 이전 노트에 제125회 3교시 4번으로 기록되어 있으나 공식 문제지 원문은 대조하지 못했다. 열거한 세부 요구사항을 기출 원문으로 확정하지 않는다.
