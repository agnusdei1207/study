...
| 구분 | 핵심 |
|---|---|
| 정의 | **전자증명서**는 행정기관이 특정 사실이나 관계를 증명하려고 전자 형태로 발급하는 민원문서 |
| 목적 | 종이 발급·전달 절차를 줄이고 증명서를 전자적으로 제출·확인하게 하는 것 |
...
전자증명서의 개념과 발급·유통 절차, 분산원장 기술과의 연계 시 고려사항을 설명하시오. *(예상; 제121회 관련 문항의 공식 원문 미대조)*
...
- 이전 노트에 제121회 4교시 2번으로 기록되어 있으나 공식 문제지 원문은 대조하지 못했다. 위 문항은 예상문제로 취급한다.
