...
- **협상에 의한 계약**: 제안서를 평가해 협상적격자를 선정하고, 협상으로 계약 상대자를 정하는 물품·용역 계약 방식.
- **협상적격자**: 입찰공고와 적용 기준이 정한 기술능력 등 요건을 충족해 협상 대상이 된 입찰자.
- **제안서평가위원회**: 제안서를 공고된 기준에 따라 심의·평가하는 위원회.
- **우선협상대상자**: 종합평가 순위에 따라 가장 먼저 협상하는 협상적격자.
...
공공 기관의 정보시스템 구축업체 선정 및 계약 체결에 있어 협상에 의한 계약 방식의 개념, 추진 절차, 제안서 평가 기준 및 기술성 중심 낙찰 방안을 설명하시오. *(예상)*
...
- 제122회 4교시 2번과 제84회 관련 문항은 이전 노트에 기출로 기록되어 있으나 공식 원문을 대조하지 못했다. 위 문항은 예상문제로 취급한다.
