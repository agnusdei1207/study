...
| KISA | 한국인터넷진흥원(Korea Internet & Security Agency)으로, 운영기준 평가 결과의 적정성을 심사하는 기관 |
...
| 구분 | 핵심 |
|---|---|
| 정의 | **전자서명법**은 전자서명의 효력과 인증업무의 신뢰 기반을 정하는 법률 |
| 목적 | 특정 전자서명 수단의 독점 지위를 없애고 다양한 전자서명 서비스 이용을 촉진하는 것 |
...
2020년 전자서명법 개정의 취지와 민간 전자서명수단의 유형, 전자서명 시장의 발전방향을 설명하시오. *(예상; 제122회 관련 문항의 공식 원문 미대조)*
...
- 이전 노트에 제122회 4교시 3번으로 기록되어 있으나 공식 문제지 원문은 대조하지 못했다. 위 문항은 예상문제로 취급한다.
