...
| 구분 | 핵심 |
|---|---|
| 정의 | **조달청 협상에 의한 계약 제안서평가 세부기준**은 조달청장이 협상계약의 제안서 평가를 집행할 때 필요한 세부사항을 정한 행정규칙 |
| 목적 | 공개된 기준에 따라 제안서를 평가하고 협상적격자를 선정 |
...
## 2~4교시 예상문제 (25점)
> 제136회 4교시 3번: 대규모 중요 소프트웨어 사업 평가의 전문성을 높이고 수요기관의 전문성을 보완해 공정한 경쟁을 유도하기 위하여 「조달청 협상에 의한 계약 제안서평가 세부기준」이 2024년 9월 개정·시행되었다. 가. 계약 제안서평가 세부기준 개정 주요 내용, 나. 대형소프트웨어 사업 전문평가제도를 설명하시오. (기출)
...
현행 기준은 조달청지침 제379호로 2026년 1월 26일 시행 중이다. 아래 2024년 9월 개정은 실제 기출문항의 출제 시점을 설명하는 연혁이며, 현재 적용 기준은 입찰 시점의 현행 세부기준과 개별 공고로 확인한다.
...
2024년 개정 당시 보도자료에 제시된 적용 금액은 역사적 안내 기준이다. 2026년 현행 기준의 적용 대상·평가방식은 후속 개정 내용을 확인해야 하며, 이 노트는 확인되지 않은 현재 금액을 단정하지 않는다.
...
| 정책 수단 | 기대하는 변화 |
|---|---|
| 분야 전문가의 심층 평가 | 기술 역량 평가의 전문성 보완 |
| 발표 요건 조정 | 입찰 준비 부담 경감 |
| 허위·비방 처리 기준 | 평가 분쟁 예방 지원 |
...
## 출제 이력 및 검증 출처
- 출제 이력: [Q-Net 제136회 정보관리기술사 공개 문제](https://www.q-net.or.kr/cst006.do?artlSeq=5234951&brdId=Q006&gSite=Q&id=cst00602)의 4교시 3번 원문을 대조했다. 기출 요구는 개정 주요 내용과 대형소프트웨어 사업 전문평가제도이며, 차등점수제는 원문 요구가 아니다.
- [조달청 협상에 의한 계약 제안서평가 세부기준(조달청지침 제379호, 2026.1.26 시행), 국가법령정보센터](https://www.law.go.kr/LSW/admRulLsInfoP.do?admRulSeq=2100000273638)
