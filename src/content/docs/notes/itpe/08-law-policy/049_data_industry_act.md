...
| 구분 | 핵심 |
|---|---|
| 정의 | **데이터산업법**은 데이터의 생산·거래·활용을 촉진하고 데이터산업 기반을 조성하는 기본법 |
| 목적 | 데이터의 경제적·사회적 활용과 데이터산업의 지속적 발전 지원 |
...
## 2~4교시 예상문제 (25점)
> 「데이터 산업진흥 및 이용촉진에 관한 기본법」의 목적과 주요 내용, 기대 효과를 설명하시오. (예상)
...
민간 데이터의 경제적·사회적 활용을 지원하되 개인정보 보호, 저작권 등 다른 법률에 따른 권리를 무효화하거나 포괄적인 데이터 소유권을 창설하지 않는다. 2021년 제정되어 2022년 4월 20일 시행되었다.
...
## 출제 이력 및 검증 출처
- 출제 이력: 이전 노트의 제127회 4교시 4번 표기는 공식 원문을 대조하지 못했다. 위 문항은 예상문제로 취급한다.
- [데이터 산업진흥 및 이용촉진에 관한 기본법(2026.8.28 시행), 국가법령정보센터](https://law.go.kr/lsLinkCommonInfo.do?lsJoLnkSeq=1017658309)
