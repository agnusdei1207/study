...
- [ ] 3NF의 정의적 허점(주속성 허용)과 BCNF가 이를 극복한 단일 규칙을 수학적으로 서술할 수 있는가?
- [ ] 학번-과목-담당교수 사례에서 발생하는 삽입, 삭제, 수정 이상의 구체적 시나리오를 제시할 수 있는가?
- [ ] BCNF 분해 시 체이스 알고리즘(Chase Algorithm)을 통한 무손실 조인 증명 과정을 설명할 수 있는가?
- [ ] BCNF 분해에 따른 종속성 보존 손실(Loss of Dependency Preservation)의 발생 원인과 실무 대응 방안을 제시할 수 있는가?
