...
- [ ] 데이터 이관 5단계(계획-설계-개발-모의이관-본이관)의 활동과 단계별 주요 산출물을 제시할 수 있는가?
- [ ] 빅뱅 이관, 단계적 이관, 병렬 운영 이관의 특성을 다운타임과 리스크 관점에서 비교할 수 있는가?
- [ ] Direct Path Insert, Nologging, Index Unusable 등 대용량 벌크 적재 최적화 메커니즘을 설명할 수 있는가?
- [ ] 건수 대사, 합계 대사, 행 해시 체크섬 대사로 이어지는 3단계 정합성 검증 체계를 설명할 수 있는가?
