...
- [ ] 인과관계가 성립하기 위한 3대 조건(시간적 선행성, 공변성, 비허위성)의 개념을 설명할 수 있는가?
- [ ] 단순 상관관계 $P(Y|X)$와 인과적 개입 $P(Y|do(X))$의 수학적·개념적 차이를 비교할 수 있는가?
- [ ] A/B 테스트가 모든 교란변수를 통제하여 순수한 처치 효과(ATE)를 산출하는 원리를 기술할 수 있는가?
