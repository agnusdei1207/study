...
- [ ] 데이터베이스의 4대 정의(통합, 저장, 운영, 공용)와 4대 특성(실시간, 변화, 공유, 내용참조)을 서술할 수 있는가?
- [ ] ANSI/SPARC 3단계 스키마 구조도와 사상(Mapping)의 역할을 도식화할 수 있는가?
- [ ] 논리적 데이터 독립성과 물리적 데이터 독립성의 개념적 차이와 실현 방안을 비교할 수 있는가?
