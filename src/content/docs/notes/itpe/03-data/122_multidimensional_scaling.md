...
- [ ] 계량적 MDS와 비계량적 MDS의 입력 척도 및 거리 보존 방식의 차이를 설명할 수 있는가?
- [ ] Kruskal Stress-1의 수식과 적합도 판정 기준(0.05, 0.10, 0.15)을 기술할 수 있는가?
- [ ] MDS 지각도에서 축(Axis) 해석의 주관성을 극복하기 위한 다변량 속성 피팅(Property Fitting)의 원리를 설명할 수 있는가?
