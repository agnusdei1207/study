...
- [ ] 데이터 커머스의 4대 상품 유형(DaaS API, 데이터셋, 안심구역, 결합상품)의 특징을 설명할 수 있는가?
- [ ] 데이터 가치평가의 3대 접근법(원가법, 시장법, 수익접근법)의 장단점을 비교할 수 있는가?
- [ ] 데이터 클린룸(Data Cleanroom)이 무단 복제 및 개인정보 유출을 방지하는 엔지니어링 원리를 설명할 수 있는가?
