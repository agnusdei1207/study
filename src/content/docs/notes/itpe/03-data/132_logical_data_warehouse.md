...
- [ ] 로지컬 DW 4계층 아키텍처의 구성요소와 각 계층의 역할을 도식화할 수 있는가?
- [ ] 전통적 물리 EDW, 로지컬 DW, 데이터 레이크하우스의 통합 방식 및 장단점을 비교할 수 있는가?
- [ ] LDW에서 활성 메타데이터 기반의 지능형 데이터 패브릭(Data Fabric)으로의 발전 양상을 기술할 수 있는가?
