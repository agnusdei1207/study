...
- [ ] 피어슨 상관계수와 스피어만 순위상관계수의 수식적 차이와 적용 조건을 비교할 수 있는가?
- [ ] 앤스컴 콰르텟(Anscombe's Quartet)이 데이터 분석가에게 주는 통계적 교훈을 설명할 수 있는가?
- [ ] 제3의 잠복변수로 인해 발생하는 허위 상관(Spurious Correlation)의 메커니즘과 편상관분석을 통한 해결책을 제시할 수 있는가?
