...
- [ ] 데이터산업법 제20조에 따른 데이터 품질인증 제도의 법적 근거와 목적을 서술할 수 있는가?
- [ ] 데이터 내용 인증(DQC-V)의 4대 품질 지표와 Class A, B, C 등급 기준을 제시할 수 있는가?
- [ ] 데이터 관리체계 인증(DQC-M)의 5단계 성숙도 레벨(도입~최적화)의 특징을 설명할 수 있는가?
- [ ] 인증 취득 후 품질 유지를 위한 DataOps 기반 상시 품질 검증 파이프라인 아키텍처를 제시할 수 있는가?
