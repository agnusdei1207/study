...
- [ ] [Ⅰ 개요]: 데이터 관리와 데이터 거버넌스의 본질적 차이를 2줄로 구분하였는가?
- [ ] [Ⅱ 요소]: 원칙, 조직, 프로세스, 기술, 성과의 5대 구성요소를 설명하였는가?
- [ ] [Ⅲ R&R]: CDO, Data Owner, Data Steward, Data Custodian의 책임을 비교하였는가?
- [ ] [Ⅳ 모델]: 중앙집중형, 분산형, 연합형(Federated) 거버넌스의 장단점을 비교하였는가?
