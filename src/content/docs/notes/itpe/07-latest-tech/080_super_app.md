...
## 2~4교시 예상문제 (25점)
> 슈퍼앱의 정의와 주요 요소, 멀티앱과의 차이, 미니앱의 역할 및 사례·전망·이슈를 설명하시오. (예상·제133회 기출 요구 반영)
...
| 구분 | 슈퍼앱 | 멀티앱 |
|---|---|---|
| 서비스 진입 | 하나의 호스트 앱에서 여러 서비스 탐색 | 서비스별 독립 앱에 각각 진입 |
| 공통 기능 | 호스트의 인증·결제·알림 등을 연계할 수 있음 | 앱별로 기능·계정·운영을 분리할 수 있음 |
| 변경 영향 | 공통 플랫폼 장애가 여러 서비스로 전파될 수 있음 | 특정 앱 장애의 영향 범위를 상대적으로 분리하기 쉬움 |

Alipay는 호스트 앱 안에서 별도 설치 없이 미니 프로그램을 실행하는 사례다. 확장 시에는 개발자 참여와 서비스 접근성이 좋아질 수 있으나, 호스트 의존·개인정보 권한·수수료·상호운용성 문제를 함께 검토한다.
...
## 출제 이력과 검증 출처
- [Q-Net 제133회 정보관리기술사 공개 문제](https://www.q-net.or.kr/cst006.do?artlSeq=5213315&brdId=Q006&gSite=Q&id=cst00602) 3교시 3번은 가. 정의·주요 요소, 나. 슈퍼앱과 멀티앱 비교, 다. 미니앱, 라. 사례·전망·이슈를 요구한다.
- [Alipay Mini Program 공식 개발 문서](https://miniprogram.alipay.com/docs/): 호스트 앱 안에서 실행하는 미니 프로그램 사례.
