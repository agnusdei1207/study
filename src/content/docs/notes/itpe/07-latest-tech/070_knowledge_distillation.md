...
| 문제 | 해결 방안 |
|---|---|
| 교사의 오류·편향이 학생에 전달될 수 있음 | 정답 자료·안전 평가를 보조 신호로 사용하고 오류 유형별 결과를 확인 |
| 교사와 학생의 구조·표현 차이로 직접 정렬이 어려울 수 있음 | 출력 기반부터 적용하고 필요하면 대응 층·투영 방법을 검증 |
| 증류가 정확도·지연·메모리를 자동 개선한다고 오해할 수 있음 | 목표 하드웨어·과업에서 기준 모델과 품질·비용을 직접 비교 |
