...
- **TF-IDF(Term Frequency-Inverse Document Frequency):** 문서 내 빈도와 말뭉치 내 희소성을 결합해 단어 가중치를 계산하는 통계량이다.
...
## 1교시 예상문제 (10점)
> TF-IDF의 개념과 계산 구조, 정보검색·분류 적용 시 장단점과 보완 방안을 설명하시오. (예상)
