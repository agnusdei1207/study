...
- **ReAct(Reasoning and Acting):** 언어 모델의 추론과 도구 행동을 번갈아 수행하는 패턴이다.
- **CoT(Chain-of-Thought):** 문제 풀이 중간 추론 단계를 이용하는 프롬프트·생성 접근이다.
...
## 1교시 예상문제 (10점)
> ReAct 패턴의 개념과 Thought-Action-Observation 동작 흐름을 설명하시오. (예상)
