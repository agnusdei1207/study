...
| 문제 | 해결 방안 |
|---|---|
| 기상·이용 행태 변화로 예측 오차가 커질 수 있음 | 시간대·자원별 오차를 계속 측정하고 상황별 예비 운영 여유를 확보 |
| 잘못된 예측이 자동 제어에 전달될 수 있음 | 운영자 승인·운전 한계·비상 중지 절차를 제어 경로에 적용 |
| 자원 통신 중단이나 데이터 품질 저하를 늦게 발견할 수 있음 | 계량·통신 상태를 감시하고 누락 시 안전한 대체 운영을 정함 |
