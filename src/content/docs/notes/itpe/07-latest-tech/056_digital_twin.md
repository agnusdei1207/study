...
화살표는 관측 정보의 전달, 요청 및 분석 결과의 반환을 뜻한다. 센서·통신·모델·응용 기능은 대상과 목적에 따라 구성한다. ISO 23247은 제조 분야의 참조 프레임워크이므로 구현에서는 적용할 정보 교환 방식과 현장 데이터 모델을 구체화한다.
...
- ISO, [ISO 23247-1:2021 일반 원칙](https://www.iso.org/standard/75066.html), [ISO 23247-4:2021 정보 교환](https://www.iso.org/standard/78745.html): 제조 분야 프레임워크와 정보 교환의 표준 범위를 확인함.
