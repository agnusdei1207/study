...
| 문제 | 해결 방안 |
|---|---|
| 서비스 편익이 커져도 일부 이용자는 접근 장벽 때문에 배제될 수 있음 | 장애·고령·저숙련 이용자를 포함해 설계·사용성 시험을 수행 |
| 피해 신고가 운영 개선으로 이어지지 않을 수 있음 | 신고·이의제기·사고 기록을 담당 조직과 개선 절차에 연결 |
| 위험이 서비스 출시 뒤에야 드러날 수 있음 | 기획·개발·운영 단계별 영향 평가와 재점검을 수행 |
