...
- **휴머노이드 로봇**: Humanoid Robot. 사람과 유사한 형상을 이용해 이동·조작 과업을 수행하는 로봇
- **전신 제어(Whole-Body Control)**: 여러 관절·접촉 조건을 함께 고려해 로봇 몸 전체의 동작을 제어하는 방식이다.
...
## 1교시 예상문제 (10점)
> 휴머노이드 로봇의 개념과 인식·계획·전신 제어 구조를 설명하시오. (예상)
...
| 구분 | 핵심 |
|---|---|
| 정의 | **휴머노이드 로봇**은 사람과 유사한 형상으로 이동·조작 과업을 수행하도록 설계한 로봇 |
| 목적 | 사람 중심 환경에서 다양한 물리 작업 지원 |
