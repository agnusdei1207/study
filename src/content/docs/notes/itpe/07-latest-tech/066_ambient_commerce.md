...
| 문제 | 해결 방안 |
|---|---|
| 구매 동작 추정이 틀리면 이용자가 알지 못한 청구가 발생할 수 있음 | 결제 전 확인·수정 기회를 제공하고 거래 내역·환불 경로를 명확히 안내 |
| 상시 감지가 프라이버시 우려를 키울 수 있음 | 수집 목적·범위를 공개하고 원본 보유를 최소화하며 이용자 통제권 제공 |
| 센서가 불확실한 상황에서도 자동 결제할 위험 | 신뢰도 기준 미달 시 자동 확정을 중단하고 직원·기존 결제 방식으로 전환 |
