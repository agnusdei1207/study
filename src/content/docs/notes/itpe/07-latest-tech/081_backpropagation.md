...
## 2~4교시 예상문제 (25점)
> 인공신경망에서 순전파·역전파의 절차와 연쇄 법칙에 따른 기울기 계산 원리, 기울기 소실의 원인과 대응 방안을 설명하시오. (예상; 제133회 3교시 6번의 역전파 항목을 확장)
...
## 출제 이력과 검증 출처
- [Q-Net 제133회 정보관리기술사 3교시 6번](https://www.q-net.or.kr/cst006.do?artlSeq=5213315&brdId=Q006&gSite=Q&id=cst00602): 인공신경망의 개념·구성요소·역할, 피드포워드 뉴럴 네트워크의 개념·절차, 역전파의 개념·절차, 활성화 함수의 종류·역할을 요구한다. 연쇄 법칙과 기울기 소실은 이 노트의 학습 확장 내용이다.
