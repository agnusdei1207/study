...
- 정의: 스프링 부트는 자동 설정, Starter 의존성, 내장 서버를 제공해 독립 실행형 스프링 애플리케이션을 구성하는 프레임워크다.
- 목적: 반복 설정과 배포 구성을 줄여 애플리케이션을 빠르게 실행하고 운영하게 한다.
...
- 제언: 자동 설정의 적용 조건을 확인하고, 운영 환경에서는 Actuator 노출 범위와 보안을 점검한다.
---
