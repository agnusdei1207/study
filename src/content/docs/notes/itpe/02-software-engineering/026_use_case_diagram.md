...
- 정의: **유스케이스 다이어그램**은 액터가 시스템에서 이용할 기능과 그 관계를 보여 주는 그림이다.
- 목적: 외부에서 필요한 기능 범위를 확인하고 명세·시험의 기준을 만든다.
...
- **경계 확인**: 액터가 얻는 결과를 기준으로 유스케이스를 나눈다.

제언: 기본·대안·예외 흐름을 명세해 다이어그램의 기능 범위를 시험에 연결한다.
---
...
| 구분 | 핵심 |
|---|---|
| 정의 | 액터·시스템 경계·유스케이스의 관계와 기본·대안 흐름을 모델링 |
| 목적 | 외부에서 필요한 기능 범위를 확인하고 구현·인수시험의 공통 기준 마련 |
...
| 문제 | 해결 방안 |
|---|---|
| 유스케이스를 내부 작업 단계별로 지나치게 쪼갬 | 액터가 얻는 결과를 기준으로 경계를 다시 정하고 세부 절차는 명세에 기록 |
| 다이어그램만 있어 완료 조건이 불명확함 | 기본·대안·예외 흐름과 사후 조건을 적어 시험 시나리오로 연결 |
---
