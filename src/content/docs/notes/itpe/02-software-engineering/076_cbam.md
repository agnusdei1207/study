...
| 위험 | 대책 | 효과 |
|---|---|---|
| **이해관계자의 주관적 효용 판단** | 시나리오별 가중치와 유틸리티 가정의 근거를 기록하고 민감도 비교 |
| **아키텍처 전략의 기대 반응을 과대평가** | 근거가 있는 측정치와 추정 범위를 함께 기록 |
| **비용 추정의 누락·불확실성** | 개발·운영 기간과 비용 항목을 분리하고 추정 가정·불확실성을 명시 |
| **ROI만으로 위험·일정을 간과** | 편익·비용 외에도 위험과 일정 제약을 함께 검토 |
---
