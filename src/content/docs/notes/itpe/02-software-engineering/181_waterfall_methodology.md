...
**제언:** 단계별 산출물의 승인과 변경 통제를 연결하고, 요구가 불확실한 부분은 조기에 사용자 피드백을 받는다.
...
## 검증 출처
- [Winston W. Royce, Managing the Development of Large Software Systems](https://doi.org/10.7551/mitpress/12274.003.0035): 단계식 개발 논의와 반복·시험의 원저 맥락
