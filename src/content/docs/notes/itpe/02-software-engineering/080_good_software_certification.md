...
- **개념**: 공인 시험·평가기관이 ISO/IEC 25023 국제표준 기반으로 상용 소프트웨어 완제품의 기능성, 신뢰성, 상호운용성 등을 블랙박스 실환경에서 검증하여 적합성을 공적으로 증명하는 제도.
- **배경**: 패키지/상용 SW의 품질 신뢰성을 객관적으로 담보하여 외산 제품 의존도를 낮추고 공공 조달 진입 및 분리발주를 활성화하기 위해 법제화됨.
