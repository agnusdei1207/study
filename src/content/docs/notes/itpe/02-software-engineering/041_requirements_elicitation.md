...
- 제언: 업무 영향이 크거나 이해가 불확실한 요구부터 정보원을 정해 교차 확인하고, 출처·가정·미결정 상태를 기록한다.
---
...
> 도출 품질은 각 요구의 출처·목적·확인 결과가 기록되고, 미해결 충돌이 결정권자에게 전달되는지로 살핀다.
...
| 문제 | 해결 방안 |
|---|---|
| 제한된 일정에서 모든 업무 흐름과 이해관계자를 같은 깊이로 조사하기 어려움 | 제언: 영향도와 불확실성이 큰 업무·역할을 먼저 표본으로 정해 인터뷰와 관찰을 결합하고, 확인 뒤 남은 흐름의 조사 범위를 조정한다. |
---
