...
> **형상관리**는 요구사항·코드·시험 산출물의 버전과 변경 이력, 승인된 기준선을 관리하는 활동.
...
> **베이스라인**은 검토·승인된 산출물의 기준 버전이자 변경 통제의 출발점.
...
> 변경 영향과 승인 권한을 확인한 뒤 구현·검증 결과를 기준선에 반영.
...
- 변경의 중요도와 조직 규칙에 따른 CCB 또는 위임 승인자의 판정 및 근거 기록.

## Ⅳ. 형상관리 한계·대응책

> 저장소 방식과 관계없이 승인된 변경·기준 버전·실제 배포 산출물의 일치 확인.
...
> 변경 영향에 맞는 승인 절차와 배포 산출물·승인 기준선의 일치 검증.
