...
| 구분 | 핵심 |
|---|---|
| 정의 | **요구공학**은 이해관계자의 요구를 도출·분석·명세·검증하고 생애주기 동안 변경을 관리하는 공학 활동이다. |
| 목적 | 요구를 명확하고 검증 가능하게 합의하고 변경을 통제한다. |
...
| 문제 | 해결 방안 |
|---|---|
| 승인된 요구 변경이 설계·구현·시험에 미친 영향과 수용 근거를 잇기 어려움 | 제언: 요구 식별자를 기준으로 변경 요청과 영향받는 설계·코드·시험을 연결하고, 영향 검토와 수용 기준 갱신을 마친 뒤 기준선을 승인한다. |
---
