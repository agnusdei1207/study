...
- **본질**: 서비스 메시는 분산 서비스 간 통신의 보안·라우팅·관측 정책을 공통 데이터 플레인에서 관리하는 인프라 계층
...
| **배치 아키텍처** | 사이드카 또는 공유 프록시 등 구현별 데이터 플레인 | 외부 요청 진입 경계 | 각 서비스 애플리케이션 코드 내부 |
...
- [Istio, Sidecar or ambient](https://istio.io/latest/docs/overview/ambient/)
