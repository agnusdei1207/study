...
> 공공SW사업 법제도 가이드 (NIPA)의 정의와 목적, 핵심 메커니즘을 설명하시오. (예상)
...
- 정의: 개정 소프트웨어진흥법을 바탕으로 불명확한 요구사항 발주, 무상 과업 추가, 강제 파견 상주 등 공공SW 시장의 고질적 불공정 관행을 타파하고, 'SW 제값 주기'와 수주자 권익을 보호하기 위해 정보통신산업진흥원(NIPA)이 기획부터 사후관리까지 전 주기 절차를 체계화한 국가 표준 사업 집행 지침
- 목적: 공공 소프트웨어 사업의 기획·발주·수행에서 준수할 절차와 책임을 안내한다.
...
- 제언: 사업 유형과 시점에 적용되는 현행 법령·고시를 확인하고 발주·검수 기록을 남긴다.
---

## 2~4교시 예상문제 (25점)

> 공공SW사업 법제도 가이드 (NIPA)의 개념과 목적을 설명하고, 핵심 메커니즘과 구성요소·절차, 적용 시 문제점과 대응 방안을 제시하시오. (25점, 예상)
