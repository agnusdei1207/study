...
> SW 개발방법론 비교(구조적·정보공학·객체지향·CBD)의 정의와 목적, 핵심 메커니즘을 설명하시오. (예상)
---
...
- 정의: 소프트웨어 개발의 생산성 저하와 품질 편차를 극복하기 위해, 시스템을 분석·설계하는 핵심 추상화의 중심축을 기능(구조적), 전사 데이터(정보공학), 객체(객체지향), 독립 실행 부품(CBD)으로 발전시켜 온 공학적 절차·기법·산출물의 종합 수행 체계
- 목적: 구조적·정보공학·객체지향·컴포넌트 방법론의 분석·설계 관점을 비교해 선택한다.
...
- 제언: 요구의 안정성, 데이터 복잡도, 재사용 범위에 따라 방법론을 정하고 산출물 간 추적성을 유지한다.
---

## 2~4교시 예상문제 (25점)

> SW 개발방법론 비교(구조적·정보공학·객체지향·CBD)의 개념과 목적을 설명하고, 핵심 메커니즘과 구성요소·절차, 적용 시 문제점과 대응 방안을 제시하시오. (25점, 예상)
---
