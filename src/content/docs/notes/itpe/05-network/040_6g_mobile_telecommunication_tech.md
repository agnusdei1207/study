...
```text
ITU-R: IMT-2030 프레임워크·평가 기준
        ↓ 후보 기술의 평가 기준
표준화 기구: 기술 규격 개발·후보 제안
        ↓ 후보 기술 제출
ITU-R: 후보 평가·무선 인터페이스 권고
        ↓ 규격에 따른 구현·검증
장비·망 적용
```

표준화 기구의 기술 규격 개발과 ITU-R의 후보 평가·권고를 구분. 2026년 9월 현재 ITU-R의 IMT-2030 성능 요구는 작업반 합의를 마쳤고 상위 연구반의 공식 승인을 기다리는 단계이며, 구체 무선 기술을 최종 6G 표준으로 확정한 상태는 아님.
