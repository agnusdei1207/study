...
- 본질: IT 실행업무를 외부 전문조직에 맡기되 아키텍처·데이터·보안·계약 통제권은 내부에 유지하는 소싱 체계
- 메커니즘: Make or Buy → 공급자·계약 → 전환·지식이전 → SLA 운영 → Exit·재소싱
- 산출물: 소싱전략 · RFP·SLA · 전환계획 · 성과보고 · Exit Plan

<details><summary>핵심 용어</summary>

- **SLA(Service Level Agreement)**: 고객과 공급자가 합의한 서비스 수준·측정·책임 기준
- **RO(Retained Organization)**: 위탁 후에도 통제권과 핵심 역량을 유지하는 내부 잔존 조직
- **SIAM(Service Integration and Management)**: 다중 공급자의 서비스를 하나의 서비스로 통합 관리하는 모델
- **XLA(eXperience Level Agreement)**: 사용자 경험 결과를 서비스 평가에 반영하는 협약
- **Exit Plan**: 계약 종료 시 서비스·지식·자산을 다른 공급자나 내부로 이전하는 계획
...
- 정의: IT 업무 일부 또는 전부를 외부 전문조직에 위탁하고 계약·서비스 수준으로 성과와 위험을 관리하는 체계
- 목적: 핵심 역량 집중 · 전문성 활용 · 서비스 품질·비용 통제
