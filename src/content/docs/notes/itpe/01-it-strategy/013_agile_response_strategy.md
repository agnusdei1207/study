...
- **애자일 대응 전략** : 짧은 반복과 피드백을 통해 개발 우선순위와 결과물을 조정하는 방식이다.
...
| 관리 기준 | 적용 방법 |
|---|---|
| **Product Backlog** | 고객가치와 피드백으로 우선순위 조정 |
| **Sprint Goal·DoD** | 반복 목표와 완료 기준을 팀이 공유 |

**제언:** 사용자 피드백을 다음 반복의 우선순위와 작업에 반영한다.
