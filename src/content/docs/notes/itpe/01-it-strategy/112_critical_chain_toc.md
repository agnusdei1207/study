...
- 본질: CCPM·TOC는 작업 의존성과 자원 제약을 함께 고려해 프로젝트 일정을 관리하는 방식
...
| 문제 | 해결 방안 |
|---|---|
| 일률적 버퍼 비율로 인한 프로젝트별 불확실성·납기 신뢰수준 반영 부족 | 작업기간의 불확실성과 의존관계에 따른 버퍼 산정, 착수 전 작업량·버퍼 소진의 점검·복구 기준 합의, 실행 결과에 따른 다음 일정의 버퍼 조정 |
