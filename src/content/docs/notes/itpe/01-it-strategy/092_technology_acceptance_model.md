...
- 본질: **기술수용모델(TAM, Technology Acceptance Model)** 은 기술의 유용성과 사용 용이성에 대한 인식으로 사용 의도를 설명하는 모델.
...
| 구분 | 핵심 |
|---|---|
| 정의 | **기술수용모델(TAM, Technology Acceptance Model)** 은 지각된 유용성과 사용 용이성으로 기술 사용 의도를 설명하는 모델 |
