...
- **협상계약 제안서 평가**: 공고된 기준에 따라 제안서를 심사하고 협상 대상자를 정하는 조달 절차.
...
| 구분 | 핵심 |
|---|---|
| 정의 | **협상계약 제안서 평가**는 공고된 기준으로 제안서를 심사해 협상 대상자를 정하는 조달 절차 |
| 목적 | 제안 내용과 가격을 공정하게 비교하고 협상·계약 대상 선정의 근거 제공 |
...
| 2025년 7월 개정 이후 실제 입찰 | 대형 SW 사업은 20억 원 이상, 유지관리 사업은 100억 원 이상(현행 세부기준 제2조) | 전문평가 필요 여부와 배점은 최신 규정·공고 확인 |
