...
- 본질: **협상계약 제안서 평가 세부기준**은 조달청 협상계약 제안서 평가에 적용하는 집행 기준.
- 메커니즘: 제안서 요구사항과 평가항목·배점의 연결, 위원별 평가의 정해진 방식에 따른 집계, 협상 절차 반영.
- 핵심: 2024년 대형 SW 전문평가 도입 내용과 2025년 배점 변경의 구분, 실제 입찰 공고일에 적용되는 기준·제안요청서 확인.
...
| 구분 | 핵심 |
|---|---|
| 정의 | **협상계약 제안서 평가 세부기준**은 조달청 협상계약 제안서 평가의 위원·방법·항목·배점·결과 처리를 정한 집행 기준 |
| 목적 | 평가의 전문성·공정성 제고와 입찰 절차의 예측 가능성 확보 |
...
2024년 제도 도입 당시의 공통평가 60%·전문평가 40% 합산 방식과, 2025년 개정의 전문평가 배점한도 조정(기술능력평가 전체 최대 40% → **정성평가 전체 배점의 최대 50%**)의 구분. 두 수치의 현행 고정비율로서의 혼용 금지.
