...
- 본질: 정보시스템 운영 성과관리는 공공 정보시스템의 비용과 업무 성과를 평가해 유지·통합·재개발·폐기를 결정하는 제도다.
...
- **정보시스템 운영 성과관리** : 운영 중인 시스템의 지속 가치를 진단하여 폐기·통폐합 등 정비 방향을 결정하는 공공 성과관리 제도
- **성과측정** : 비용 및 업무 측면의 측정 지표에 맞춰 운영 데이터를 수집하고 정량 성과를 산출하는 측정 활동
- **성과평가** : 측정된 지표 점수와 증빙 자료를 종합 분석하여 시스템의 운영 적정성과 정비 필요성을 판정하는 평가 절차
- **정비** : 평가 결과에 따라 유지·통폐합·기능고도화·재개발·폐기 등의 구조적 개선 방안을 이행하는 사후 조치
...
> 정보시스템 운영 성과관리의 측정·정비 판정 체계를 설명하시오. (예상·10점)
...
## Ⅰ. 지속 운영 가치와 정비대상을 결정하는 성과관리의 개요
