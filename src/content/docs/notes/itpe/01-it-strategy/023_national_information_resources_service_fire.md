...
| 위험 | 대책 | 효과 |
|---|---|---|
| **Split-Brain 발생** | 제3 거점 독립 **Quorum Witness** 배치 및 펜싱 통제 | 데이터 충돌 및 트랜잭션 오염 원천 차단 |
...
| **비상 절체(Failover) 실패** | IaC 기반 자동 복구 스크립트화 및 카오스 엔지니어링 모의훈련 | 골든타임 내 자동 절체 성공률 100% 확보 |
