...
- 본질: **국가 AI 전략과 인공지능 행동계획**은 국가 AI 정책 방향을 3년 주기 법정 기본계획과 관계기관 사업으로 연결하는 범정부 추진체계이다.
- 메커니즘: 과기정통부 기본계획 수립 → 대통령 직속 국가인공지능전략위원회 심의·의결 → 부처별 시행사업 편성 및 예산 배분 → 연차별 이행점검 및 신뢰 환류한다.
- 산출물: 3년 주기 인공지능 기본계획서 · 부처별 연차 시행계획서 · 고영향 AI 위험평가 및 KPI 성과점검서이다.

<details>
<summary>핵심 용어</summary>

- **국가인공지능전략위원회**: 대통령 소속으로 AI 주요 정책을 심의·의결하는 위원회이다.
- **인공지능 기본계획**: 과학기술정보통신부장관이 3년마다 수립하고 위원회 심의·의결을 거치는 법정 계획이다.
- **AX(AI Transformation)**: 전 산업 및 공공 업무 전반에 인공지능을 내재화하여 생산성을 혁신하는 전환이다.
- **인공지능기본법**: AI 산업 육성 지원과 고영향 AI 안전·신뢰성 확보 의무를 법제화한 기본 법령이다.
- **고영향 AI(High-impact AI)**: 사람의 생명·신체·기본권에 중대한 영향을 미쳐 강화된 안전성 검증이 요구되는 AI이다.
...
- **소버린 AI(Sovereign AI)**: 외산 빅테크에 종속되지 않고 자국의 데이터와 인프라로 자체 AI 역량을 보유하는 전략이다.
...
- 문제: 개별 부처별 AI 사업 추진으로 중복 투자와 상호운용성 저하가 발생하고, 고위험 AI에 대한 신뢰성·안전성 검증 기준 미비로 국민 권익 침해 위험이 존재함.
- 해결 방안: 국가인공지능전략위원회를 중심으로 범정부 AI 컨트롤타워를 확립하여 예산 배분과 공통기반 연계를 심의하고, 인공지능기본법에 근거한 고영향 AI 위험분류 및 사업 기획부터 운영까지의 전주기 AI 안전성·신뢰성 검증 체계를 가동함.

```mermaid
flowchart TD
    subgraph Governance["1. 범정부 통합 컨트롤타워 운영"]
        G1["국가인공지능전략위원회: 정책 심의 및 부처 칸막이 제거"]
        G2["부처별 AI 사업 사전 예산 심의 및 중복 투자 방지"]
        G1 --> G2
    end
    subgraph Platform["2. 국가 AI 고속도로 및 공통 인프라 연계"]
        P1["국가 AI 컴퓨팅 센터 GPU 풀 공동 활용"]
        P2["범정부 AI 공통기반 데이터셋 및 표준 API 연계"]
        P1 & P2 --> P3["행정·산업 전반의 AI 서비스 신속 배포"]
    end
    subgraph Trust["3. 인공지능기본법 기반 안전·신뢰 통제"]
        T1["고영향 AI 판정 및 사업 전주기 영향평가"]
        T2["환각·편향 방지 및 Human-in-the-loop 검증 의무화"]
        T1 --> T2
    end
