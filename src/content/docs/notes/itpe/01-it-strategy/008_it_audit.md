...
> 정보시스템 감리의 개념과 법적 통제 구조, 수행 흐름을 설명하시오. (예상·10점)
...
```mermaid
flowchart TD
    A["감리 범위·기준 확정"] -->|계획에 따른 점검| B["산출물·현장·증거 확인"]
    B -->|문제와 근거 정리| C["감리 결과 보고"]
    C -->|개선조치 확인| D["조치 결과 재점검"]
```

| 통제축 | 핵심 확인 |
|---|---|
| 독립성 | 발주자·사업자의 감리 판단 개입 여부 |
| 개선 확인 | 발견사항별 조치 결과와 실제 산출물·증거의 일치 여부 |

**제언:** 감리 독립성을 보장하고 지적사항별 조치 증거를 재확인

---

## 2~4교시 예상문제 (25점)

> 정보시스템 감리의 법적 통제 구조와 수행 절차를 설명하고, PMO·상주감리와의 역할 경계 및 감리 실효성 확보방안을 제시하시오. (예상·25점)
