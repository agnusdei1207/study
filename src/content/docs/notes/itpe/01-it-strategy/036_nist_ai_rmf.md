...
- **AI RMF(AI Risk Management Framework)** : AI 위험을 개인·조직·사회 관점에서 평가·관리하고 신뢰성 요건을 수명주기에 통합하는 NIST 프레임워크
- **GOVERN(거버넌스)** : AI 위험관리 문화·정책·역할·책임·감독 체계를 수립하고 전 프로세스를 통제하는 핵심 횡단 기능
- **MAP(맥락 파악)** : AI 시스템의 비즈니스 맥락, 이해관계자, 편익 및 잠재 위험 영향을 식별·매핑하는 1단계 기능
- **MEASURE(측정·평가)** : 정량적·정성적 지표와 평가 도구를 활용하여 AI 신뢰성 특성과 위험 수준을 분석·추적하는 2단계 기능
- **MANAGE(위험 관리)** : 측정된 위험의 우선순위를 결정하고 위험 완화 조치를 실행·모니터링하는 3단계 기능
- **NIST AI 600-1** : AI RMF 1.0을 환각·탈옥·저작권 등 생성형 AI 특유의 위험에 맞춰 구체화한 생성형 AI 프로파일 가이드
