...
- **AI 민주정부** : 공공 AI 활용에서 국민의 권리와 행정 책임을 지키는 공공부문 운영 방향
...
| 구분 | 핵심 |
|---|---|
| 정의 | **AI 민주정부**·온AI는 공공서비스와 행정업무에 AI를 활용하면서 국민 권리와 행정 책임을 지키려는 공공부문 운영 모델이다. |
| 목적 | 공공서비스와 업무를 개선하면서 AI 활용에 대한 공적 통제와 신뢰를 유지한다. |
...
| 문제 | 해결 방안 |
|---|---|
| 시민이 행정서비스에서 AI가 맡은 역할, 책임 부서, 문의·이의 경로를 알기 어려우면 설명과 신뢰 확보가 어려워질 수 있다. | AI 지원 서비스별 목적·사용범위·책임부서·민원 및 이의 경로를 공개하고, 기능이나 데이터 사용이 바뀔 때 정보를 갱신한다. |

이 공개목록은 책임성과 접근성을 높이기 위한 제안이다. 법적 의무와 적용 범위는 해당 행정업무에 적용되는 법령에 따라 확인한다.
