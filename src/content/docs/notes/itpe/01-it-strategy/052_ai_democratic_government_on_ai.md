...
- 본질: **AI 민주정부·온AI**: 생성형 AI를 공공서비스·행정업무에 활용하면서 사람의 감독과 행정 책임을 유지하는 추진모델.
- 메커니즘: 과제 발굴 → 적법성·영향평가 → 공통기반 연계 개발 → 인간 감독·승인 → 이의신청·사후감사.
...
| 구분 | 핵심 |
|---|---|
| 정의 | **AI 민주정부**·온AI: 공공서비스·행정업무에 AI를 활용하면서 국민 권리와 행정 책임을 지키려는 공공부문 운영모델 |
