...
- 본질: 재난·비상사태 중에도 핵심 비즈니스를 허용 가능한 최소 수준(**MBCO**)으로 지속하고, 한계 시간(**MTPD**) 전에 목표 수준으로 재개(**RTO**)하는 전사적 위기대응 종합 계획 체계.
- 메커니즘: 거버넌스 수립 → **BIA**(업무영향분석) 및 위험평가 → 4대 지표 산출(**MTPD**, **RTO**, **RPO**, **MBCO**) → 4대 실행계획 연계(**CMP**, **ERP**, **BCP**, **DRP**) → 실전 훈련(도상·절체) 및 PDCA 개선.
- 산출물: BIA 보고서 · 연속성 전략 · BCP·DRP · 훈련결과·시정조치
...
- **RTO(Recovery Time Objective)**: 재해 발생 후 업무 기능이나 시스템을 사전에 정한 목표 수준으로 재개해야 하는 목표 시간 (`RTO < MTPD`)
...
- **ERP(Emergency Response Plan)**: 인명 보호·대피 등 현장 비상상황의 초동 대응을 담당하는 비상대응 계획
