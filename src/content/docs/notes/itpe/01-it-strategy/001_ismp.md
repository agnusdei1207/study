...
|---|---|---|
| **ISMP 5단계 방법론** | 착수, 방향성 수립, 업무·기술 요건 분석, 구조·요건 정의, 구축사업 이행방안 수립 | Ⅲ 구조, Ⅳ 흐름 |
| **요건 추적성(Traceability)** | 업무요건 $\rightarrow$ 시스템요건 $\rightarrow$ 아키텍처 $\rightarrow$ FP $\rightarrow$ RFP 연결성 검증 | Ⅵ 실무, Ⅶ 결론 |
...
| 영역 | 활동 | 산출물 |
|---|---|---|
| **방향** | 전략 · 벤치마킹 · 범위 | 범위·방향서 |
| **요건** | As-Is · 인터뷰 · 기능 · 데이터 · 비기능 | 업무요건 · IT요건 |
| **구조** | To-Be 아키텍처 · 연계 · 인터페이스 | 요건기술서 · 아키텍처 |
| **이행** | 발주 · FP · 예산 · RFP | 구축계획 · 예산 · RFP |
