...
| **사후 편익 평가 부재** | 시스템 개통 1년 후 **편익 실현 감사(Benefits Realization Review)** 의무화 | 목표 대비 편익 실현율 100% 추적 |
| **무형 가치 산정 왜곡** | AHP(계층화분석법) 다기준 의사결정 및 IT-BSC 가중치 모델 적용 | 정성적 편익의 객관적 수치화 달성 |
