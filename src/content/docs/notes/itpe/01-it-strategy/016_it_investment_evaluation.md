...
문제: 투자 승인 뒤 실제 편익을 확인하지 않으면 기대가 과장됐거나 운영상 실현되지 않은 편익을 놓칠 수 있다. 제언: 승인 당시의 비즈니스 케이스와 운영 성과를 비교하고, 차이가 있으면 원인을 분석해 개선 또는 후속 투자 판단에 반영한다.

| 문제 | 해결 방안 |
|---|---|
| 승인 후 편익 실현 여부를 확인하지 않음 | 운영 성과를 승인 당시 비즈니스 케이스와 비교 |
| 기대 편익과 실제 성과에 차이가 발생 | 원인을 분석해 개선 과제와 후속 투자 판단에 반영 |
