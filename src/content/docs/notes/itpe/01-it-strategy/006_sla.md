...
| 영역 | 평가지표 | 측정방법 |
|---|---|---|
| HW | 가용성 · **RTO** · **RPO** | 가동시간 로그 · 복구훈련·백업 복원 확인 |
| SW | 장애율 · 평균 복구시간(**MTTR**) | 장애 티켓의 감지·복구 시각 · 운영 기록 |
...
| 팀 간 책임 전가 | 핸드오프 경계 OLA 명문화 · **RACI** 확립 | 실제 평균 복구시간(**MTTR**) 단축 및 **RTO** 달성 지원 |
...
문제: 제공 지표가 실제 사용자 경험을 대표하지 않거나 내부 운영조직·공급자 책임과 연결되지 않으면 SLA 달성 여부가 불명확해진다. 제언: 핵심 서비스 관점에서 측정 기준과 책임 주체를 정하고 대외 SLA에 필요한 내부 지원수준을 연계한다.
