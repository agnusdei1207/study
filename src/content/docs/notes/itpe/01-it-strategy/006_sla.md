...
- 판정: 인프라 가동률이 아니라 핵심 비즈니스 트랜잭션의 종단 SLI로 SLA 달성 여부 확인
- 대안: 대고객 SLA를 내부 OLA·외부 UC와 정렬하고 SLO에 에러 예산 연계
- 검증: 합성 트랜잭션·실사용자 모니터링으로 체감 실패와 에러 예산 소진 추적
- 효과: 체감 품질과 운영 지표의 괴리 축소·배포 속도와 신뢰성의 균형
