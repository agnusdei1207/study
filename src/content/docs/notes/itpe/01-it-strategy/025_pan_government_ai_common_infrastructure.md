...
## Ⅵ. 기술사적 제언 — 행정 업무별 AI 적용 경계 선정

> 제안: 공통기반을 도입할 때 모든 행정업무를 같은 승인 절차로 묶지 말고, **대민 안내·내부 초안·권리영향 판단 지원** 을 구분해 첫 적용 업무와 사람 검토 범위를 정한다.

| 업무 유형 | 먼저 정할 경계 | 적용 판단 |
|---|---|---|
| 내부 자료 초안 | 외부 발송 전 검토 담당 | 제한된 시범 적용 검토 |
| 대민 안내 | 최신 근거와 정정 경로 | 공개 전 근거 확인 |
| 권리영향 판단 지원 | 담당자의 검토·결정 권한 | 관련 법령과 업무절차를 먼저 확인 |

Ⅴ절은 공통기반의 보안·운영 위험을 비교했다. 이 제안은 **어느 업무부터 어떤 검토 조건으로 쓸지** 정한다. AI의 답변이 행정청의 처분을 대신한다는 뜻이 아니다.
