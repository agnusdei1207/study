...
- **E2E(End-to-End)** : 시작부터 최종 결과까지 전체 흐름을 연결해 보는 관점.
...
> 가치사슬의 개념·목적과 본원적·지원 활동의 구조를 설명하시오. (예상·10점)
...
**제언:** 비용·품질·납기 자료에서 개선할 활동 간 연계 한 곳을 골라 우선 점검.

---

## 2~4교시 예상문제 (25점)

> 가치사슬(Value Chain)의 개념과 본원적·지원 활동을 설명하고, 활동 간 연계를 이용한 경쟁우위 확보 방안을 제시하시오. **(예상·25점)**
...
| 활동 | 주요 역할 및 정보기술 |
|---|---|
| 입고 물류 | 원자재 수급·검수·재고관리와 입고정보 관리 |
| 생산·운영 | 가공·조립·포장·설비 운영과 생산실적 관리 |
| 출고 물류 | 완제품 보관·주문처리·수송·배송 정보 관리 |
| 마케팅·영업 | 판촉·가격·채널·판매 정보 관리 |
| 사후 서비스 | 설치·수리·고객지원·부품교체 이력 관리 |

**4대 지원 활동**

| 활동 | 주요 역할 및 정보기술 |
|---|---|
| 기업 하부구조 | 전사 기획·재무회계·법무·품질경영 정보 관리 |
| 인적자원 관리 | 채용·교육훈련·성과평가·보상 정보 관리 |
| 기술 개발 | 연구개발·제품설계·공정개선 정보 관리 |
| 조달 활동 | 원자재·설비·외주용역 구매와 공급자 정보 관리 |
