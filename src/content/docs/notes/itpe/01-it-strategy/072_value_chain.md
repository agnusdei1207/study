...
- 메커니즘: 지원활동이 본원활동을 뒷받침하고, 활동별 비용과 차별화가 제품·서비스의 **마진**에 반영된다.
- 판정 기준: 활동별 비용·차별화 동인과 활동 간 인계 병목을 확인해 전사 마진 개선을 평가한다.
...
| 구분 | 핵심 |
|---|---|
| 정의 | **가치사슬(Value Chain)**은 기업 활동을 본원적 활동과 지원 활동으로 구분해 비용과 차별화의 원천, 마진을 분석하는 경영 전략 틀이다. |
...
| 문제 | 해결 방안 |
|---|---|
| 전사 활동을 한 번에 디지털화하면 병목이나 마진에 영향을 주지 않는 연계까지 시스템화해 비용이 늘 수 있다. | 비용·품질·납기 자료로 우선 개선할 연계를 선정하고, 해당 활동의 책임자와 전후 지표를 정해 개선 효과를 검증한 뒤 다른 활동으로 확장한다. |
