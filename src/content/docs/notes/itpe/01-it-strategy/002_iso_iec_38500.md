...
**6대 기본 원칙(책·전·획·성·준·인)**은 비즈니스 정렬과 거버넌스 통제의 두 축으로 묶어 재현한다.

| 축 | 원칙 | 점검 기준 |
|---|---|---|
| 비즈니스 정렬 | 전략(Strategy) · 획득(Acquisition) · 성과(Performance) | 비즈니스 전략과 IT 역량 연계, 비용·위험·편익 근거의 투자 판단, 적시 성과 제공 |
| 거버넌스 통제 | 책임(Responsibility) · 준수(Conformance) · 인간 행동(Human Behaviour) | IT 수요·공급 권한 명시, 법규·계약·정책 적합성, 이해관계자 행동·변화관리 |

- 프레임워크 6요소: Direction · Capability · Policy · Delegation · Performance · **Accountability**가 원칙을 조직 안에서 작동시키는 통제 구조
