...
문제: ESG 지표의 원천과 산출 근거를 추적하기 어려우면 공시 데이터의 신뢰성을 확인하기 어렵다. 제언: 지표별 책임자와 원천자료·산정방법을 정하고 변경이력을 보존해 내부 검토와 외부 확인에 활용한다.

| 문제 | 해결 방안 |
|---|---|
| 공시값의 원천과 책임자가 불명확 | 지표별 책임자·원천자료·산정방법을 지정 |
| 산정값의 변경 근거를 추적하기 어려움 | 산정기준과 변경 이력을 기록하고 검토 절차 운영 |
