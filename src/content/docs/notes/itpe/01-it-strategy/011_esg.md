...
- 본질: ESG(Environmental, Social, Governance)는 환경·사회 영향과 책임 있는 기업 운영을 경영 판단에 반영하는 관점
- 메커니즘: 공시 요구사항 정의 → 원천 데이터 수집 → 산정·검증 → 승인·공시 → 목표·통제 반영
- 산출물: **ESG** 지표 사전·온실가스 인벤토리·증빙·승인 이력·지속가능성 공시

<details>
<summary>핵심 용어</summary>

- **ESG 경영** : 환경·사회·지배구조의 위험과 기회를 경영 의사결정·성과 관리에 반영하는 활동
...
| 구분 | 핵심 |
|---|---|
| 정의 | **ESG 경영** 은 환경·사회·지배구조의 위험과 기회를 경영 의사결정·성과 관리에 반영하는 활동 |
| 목적 | 지속가능성·이해관계자 신뢰 향상과 관련 위험 관리 |
...
| 통제 대상 | 확인할 내용 |
|---|---|
| 공시 기준 | ISSB IFRS S1·S2와 GHG Protocol에 맞는 지표·경계 |
| 데이터 계보 | 원천 수집부터 산정·공시까지 변경·검증 이력 |

**제언:** 공시 지표의 책임자·원천·산정 근거·변경 이력에 대한 추적성 확보
...
> 공시 수치 신뢰성의 판단 근거인 원천 자료부터 공시 항목까지의 데이터 계보와 재수행 가능한 산식
...
> Scope 분류 기준인 배출원 위치가 아닌 보고기업의 소유·통제·**가치사슬** 관계, 관할권별 공시 의무 채택 범위의 별도 확인
...
> 자동 수집과 별도로 필요한 경계·산식·증빙·승인 통제의 설계
...
> 제안: 전체 ESG 데이터의 일괄 정비보다 공시에 쓰이고 원천이 여러 조직에 걸친 지표를 우선 선정해 **원천 자료에서 공시값까지** 재계산
...
Ⅴ절의 데이터 오류 유형·통제와 구분되는 **우선 검증 지표 선정 기준**
