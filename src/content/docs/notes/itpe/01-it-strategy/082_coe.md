...
- 본질: **CoE(Center of Excellence)** : 특정 분야의 전문성·표준·재사용 자산을 모아 현업팀의 적용을 돕는 조직.
...
| 구분 | 핵심 |
|---|---|
| 정의 | **CoE(Center of Excellence)** : 특정 기술의 전문 지식·공통자산을 모아 현업팀의 적용을 돕는 조직 |
