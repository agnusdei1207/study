...
- 본질: **품질비용(COQ)**은 제품·서비스의 품질을 확보하는 활동과 품질 실패로 발생한 비용을 함께 다루는 개념이다.
- 메커니즘: 예방·평가 비용과 내부·외부 실패비용을 같은 기준으로 분류해 개선 우선순위를 정한다.

<details>
<summary>핵심 용어</summary>

- **품질비용(COQ)** : 품질을 확보하는 활동에 든 비용과 품질 실패로 발생한 비용을 함께 분류·관리하는 개념
...
| 구분 | 핵심 |
|---|---|
| 정의 | **품질비용(COQ)**은 제품·서비스의 품질을 확보하는 활동과 품질 실패로 발생한 비용을 함께 다루는 개념이다. |
| 목적 | 비용이 큰 실패 원인을 찾아 예방·평가 활동의 개선 우선순위를 정한다. |
...
> 예방·평가 활동과 실패 손실을 함께 보되, 특정한 비용 곡선이나 보편적 최적점을 전제하지 않는다.
...
예방·평가 투자 효과는 제품·도메인·결함 유형에 따라 다르므로 고정 배수나 일률적 최적점을 적용하지 않는다.
