...
> 시스템 운영·유지보수 감리의 정의·목적과 운영통제 점검의 기본 구조를 설명하시오. (예상·10점)
...
flowchart TD
    ...
    OP -->|"운영 로그·계정·백업 원시증적"| CAAT["원시증적 교차검증"]
    MAINT -->|"요구·승인·시험·배포 원시증적"| CAAT
```
...
- 제137회 관련 문항으로 정리된 이력은 있으나 공식 문제지 원문과 정확한 문구는 미확보
