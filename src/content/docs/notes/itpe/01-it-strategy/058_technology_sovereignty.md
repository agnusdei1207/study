...
| 구분 | 핵심 |
|---|---|
| 정의 | **기술 주권**은 핵심 기술·서비스를 선택·운영하고 의존위험을 관리할 수 있는 역량이다. |
| 목적 | 핵심 기능의 연속성과 기술 선택권을 지킨다. |
...
| 문제 | 해결 방안 |
|---|---|
| 계약서의 이전 조항과 구성목록만으로는 핵심서비스를 다른 공급환경으로 실제 옮길 수 있는지 알기 어렵다. | 중요 서비스부터 데이터 내보내기·대체환경 배포·접속전환을 시험하고, 막힌 의존성과 소요시간을 다음 조달·개선계획에 반영한다. |

이는 선택권을 실제 복구능력으로 확인하기 위한 제안이며 전면 국산화나 국내 저장을 일률적으로 요구하는 뜻은 아니다.
