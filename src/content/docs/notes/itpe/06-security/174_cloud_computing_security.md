...
| 구분 | 내용 |
|---|---|
| 정의 | **클라우드 보안**은 클라우드의 데이터·서비스·기반 자원을 보호하는 관리·기술 통제 |
| 목적 | 제공자·이용자 책임 경계에 따른 침해·중단 위험 감소 |
...
클라우드 보안 책임 경계
  ├─ CSP 운영 영역: 기반 서비스 통제
  └─ 고객 운영 영역: 계정·데이터·설정 통제

구체적 범위는 서비스 모델·계약에서 확인
```
...
**제언:** 도입 전 서비스별 책임표 작성과 고객 책임 항목의 담당자·점검 증거 지정.
