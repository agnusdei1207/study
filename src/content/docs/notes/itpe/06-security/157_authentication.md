...
> 식별·인증·인가의 차이와 접근통제 절차를 설명하시오. (예상)
...
정의: 인증은 사용자가 주장하는 신원이 실제 주체와 일치하는지 확인하는 보안 절차다.
목적: 인가에 앞서 접근 주체의 신원을 확인해 무단 접근을 줄인다.
...
제안: 인증 성공만으로 권한을 부여하지 말고 자원별 인가 정책도 확인한다.

---

## 2~4교시 예상문제 (25점)

> 접근통제의 식별·인증·인가 절차를 설명하고 인증 요소와 MFA 적용 시 고려사항을 제시하시오. (예상)
