...
date: "2026-09-14T15:12:00+09:00"
tags: [notes-software]
weight: 18
extra:
  question_no: "018"
...
- 대규모 멀티테넌트 환경 구축 시 하드웨어 수준의 안전한 보안 경계를 확보하기 위해 **단일 루트 입출력 가상화**(SR-IOV) 패스스루와 경량 격리 기술을 결합하는 인프라 설계 체계 구축

#### 한줄 요약
- 하드웨어 추상화와 격리의 하이퍼바이저 원리를 바탕으로, SR-IOV 하드웨어 가속과 MicroVM 기술을 결합하여 가상화 오버헤드를 최소화하고 멀티테넌트 보안 격리를 확보하도록 설계한다.