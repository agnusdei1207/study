...
sidebar:
  ...
  badge:
    ...
    variant: note
title: "DevSecOps"
date: "2026-09-14T16:19:00+09:00"
tags:
  - "notes-software"
weight: 57
extra:
...
| 오픈소스 라이브러리 취약점(CVE) 폭증 | **Snyk / Dependabot 기반 취약 라이브러리 자동 PR 및 패치** | CVE 노출 시간 최소화 및 패치 자동화 |
...
- **실무 공학적 통찰**: 보안 도구의 높은 오탐률(False Positive)로 인한 개발 병목을 차단하기 위해, **보안 챔피언**(Security Champion) 제도를 운영하고 **CVE** 위험도(CVSS)에 따른 유연하고 실효성 있는 품질 게이트 거버넌스 수립

#### 한줄 요약
- 보안 게이트 오탐 튜닝과 보안 챔피언 제도를 정착시키고, 빌드부터 런타임까지 다계층 보안 검증을 자동화하여 안전한 소프트웨어 전달 체계를 구축한다.
